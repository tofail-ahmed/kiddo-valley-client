...
const Details = () => {
      ...
      return (
            <div>
                  <div className='my-8'>
                <div className="bg-slate-200 rounded-lg shadow-lg p-6 hover:shadow-xl transition duration-300 ease-in-out transform hover:scale-105">
      <div className="relative">
        <img src={toy_pic} alt={toy_name} className="w-1/4 h-auto mb-4 rounded-md" />
      ...
      <div className="flex items-center mb-2">
        ...
        <p className="text-gray-600 text-xl">Sub-category: {subcategory} </p>
